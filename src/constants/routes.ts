export const ROUTES = {
  ...
  /** 본당 관할 구역도 */
  ABOUT_PARISH_AREA: `/about/parish-area`,
  /** 오시는 길 */
  ...
  // ===== 신앙 공동체 > 분과 관련 라우트 =====
  /** 분과 게시판 */
  COMMUNITY_DEPARTMENT_BOARD: (departmentId: number) =>
    `/community/department/${departmentId}/board`,
  /** 분과 게시판 상세 */
  COMMUNITY_DEPARTMENT_BOARD_DETAIL: (departmentId: number, boardId: number) =>
    `/community/department/${departmentId}/board/${boardId}`,
  /** 분과 게시판 생성 */
  COMMUNITY_DEPARTMENT_BOARD_CREATE: (departmentId: number) =>
    `/community/department/${departmentId}/board/create`,
  /** 분과 게시판 수정 */
  COMMUNITY_DEPARTMENT_BOARD_EDIT: (departmentId: number, boardId: number) =>
    `/community/department/${departmentId}/board/${boardId}/edit`,

  // ===== 신앙 공동체 > 각종 자료실 라우트 =====
  /** 명도회 자료실 */
  COMMUNITY_EDITORIAL_MYEONGDO: `/community/editorial/myeongdo`,
  /** 명도회 자료실 상세 */
  COMMUNITY_EDITORIAL_MYEONGDO_DETAIL: (id: number) =>
    `/community/editorial/myeongdo/${id}`,
  /** 명도회 자료실 생성 */
  COMMUNITY_EDITORIAL_MYEONGDO_CREATE: `/community/editorial/myeongdo/create`,

  /** 주보 7면 편집 */
  COMMUNITY_EDITORIAL_DRAFT: `/community/editorial/draft`,
  /** 주보 7면 편집 상세 */
  COMMUNITY_EDITORIAL_DRAFT_DETAIL: (id: number) =>
    `/community/editorial/draft/${id}`,
  /** 주보 7면 편집 생성 */
  COMMUNITY_EDITORIAL_DRAFT_CREATE: `/community/editorial/draft/create`,

  /** 주보 7면 최종본 */
  COMMUNITY_EDITORIAL_FINAL: `/community/editorial/final`,
  /** 주보 7면 최종본 상세 */
  COMMUNITY_EDITORIAL_FINAL_DETAIL: (id: number) =>
    `/community/editorial/final/${id}`,
  /** 주보 7면 최종본 생성 */
  COMMUNITY_EDITORIAL_FINAL_CREATE: `/community/editorial/final/create`,

  /** 주보 7면 양식 */
  COMMUNITY_EDITORIAL_TEMPLATE: `/community/editorial/template`,
  /** 주보 7면 양식 상세 */
  COMMUNITY_EDITORIAL_TEMPLATE_DETAIL: (id: number) =>
    `/community/editorial/template/${id}`,
  /** 주보 7면 양식 생성 */
  COMMUNITY_EDITORIAL_TEMPLATE_CREATE: `/community/editorial/template/create`,
