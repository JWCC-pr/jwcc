  ...
  return (
    <Box display="flex" flexDirection="column" gap="56px">
      ...
      <Text textStyle="pre-body-4" color="grey.10">
        ...
        <br />
        세례후에는 교회의 구성원인 신자로서 하느님의 은총 안에서 맡겨 주신
        사명을 다하며 생활하게 됩니다.
        <br />
        <br />
        신자가 되기 위한 이 교육을 &apos;예비신자 교리&apos;라고 하며, 각
        성당(본당)에서는 신부님, 수녀님, 교리교사들이 가르치고 있으며 교육기간은
        대략 6개월 정도입니다.
        <br />
        <br />
        ...
        먼저 찾아가시면 됩니다.
        <br />각 성당(본당) 사무실에 가시면 입교 및 &apos;예비신자 교리&apos;에
        대한 자세한 안내를 받으실 수 있습니다.
      </Text>
      ...
      <Box display="flex" flexDirection="column" gap="24px">
        ...
        <Text textStyle="pre-body-4" color="grey.10">
          ...
          어린 아기들에 대해서는 교회에서는 부모들에게 후에 잘 교육하겠다는
          책임을 다짐받고 세례를 주고 있습니다.
          <br />
          현재 가톨릭에서는 일반적으로 60시간 전후의 교리 수업을 받아야 세례를
          받게 합니다. 시간만이 아니라 그 기간도 최하 6개월 정도에서 1년 또는 그
          이상일 경우도 있습니다.
          <br />
          그리고 일반적으로 교리 수업이 끝난 후에는 세례를 주례할 사제(주로 본당
          주임신부)에게 배운 것에 대한 확인을 받고 결정을 얻어야 합니다.
        </Text>
      </Box>
