...
interface DepartmentBoardDetailCommentInputSectionProps {
  departmentId: number
  boardId: number
}

const DepartmentBoardDetailCommentInputSection: React.FC<
  DepartmentBoardDetailCommentInputSectionProps
> = ({ boardId }) => {
...
export default DepartmentBoardDetailCommentInputSection
